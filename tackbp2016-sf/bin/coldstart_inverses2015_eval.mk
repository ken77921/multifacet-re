...
hop1_%_pp15: hop1_% hop1_query_expanded.xml /dev/null
	$(TAC_ROOT)/components/bin/postprocess2015.sh $+ $@

hop2_%_pp15: hop2_% hop2_query_expanded.xml /dev/null
	$(TAC_ROOT)/components/bin/postprocess2015.sh $+ $@
...
response_validated_2015: response_fix_hop2_qid_2015 docs_list query.xml
	$(TAC_ROOT)/evaluation/bin/2015/validate_sf.sh $+ $@ 15

eval_2015: query.xml response_validated_2015 assessments
	$(TAC_ROOT)/evaluation/bin/2015/eval.sh $+ $@ 15
