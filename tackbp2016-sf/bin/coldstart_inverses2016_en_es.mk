...
%_pp15_noNIL_filtered_only_en: %_pp15_noNIL
	$(TAC_ROOT)/components/bin/hop2_prefiltering_only_en.sh $+ $@

hop2_query.xml: query.xml hop1_response_$(modules)_pp15_noNIL_filtered_only_en
	$(TAC_ROOT)/components/bin/generate_queries2016.sh query.xml hop2_query.xml hop1_response_$(modules)_pp15_noNIL_filtered_only_en
...
%_response_Pat_doc_exp_spa:
	cp $(shell $(TAC_ROOT)/bin/get_expand_config.sh Pat_doc_exp_recall_spa_$*_result) $@

%_response_Pat_spa:
	cp $(shell $(TAC_ROOT)/bin/get_expand_config.sh Pat_recall_spa_$*_result) $@

%_response_Pat_doc_exp_precision_spa:
	cp $(shell $(TAC_ROOT)/bin/get_expand_config.sh Pat_doc_exp_precision_spa_$*_result) $@
...
hop1_response_2016_sf_run1: hop1_query_expanded_within_doc.xml hop1_response_Pat_doc_exp_org hop1_response_Pat_doc_exp_SES hop1_response_alternate_names hop1_response_patterns hop1_response_Pat_doc_exp_spa
...
hop1_response_2016_sf_run2: hop1_query_expanded.xml hop1_response_Pat_org hop1_response_Pat_SES hop1_response_alternate_names hop1_response_patterns hop1_response_Pat_spa
	$(TAC_ROOT)/components/bin/merge_responses.sh $+ > $@
...
hop1_response_2016_sf_run3: hop1_query_expanded_within_doc.xml hop1_response_Pat_doc_exp_org hop1_response_Pat_doc_exp_SES hop1_response_alternate_names hop1_response_patterns hop1_response_Pat_doc_exp_precision_spa
	$(TAC_ROOT)/components/bin/merge_responses.sh $+ > $@

hop2_response_2016_sf_run3: hop2_query_expanded_within_doc.xml hop2_response_Pat_doc_exp_org
	$(TAC_ROOT)/components/bin/merge_responses.sh $+ > $@


hop1_response_2016_sf_run4: hop1_query_expanded.xml hop1_response_Pat_org hop1_response_Pat_SES hop1_response_alternate_names hop1_response_patterns hop1_response_Pat_doc_exp_spa
	$(TAC_ROOT)/components/bin/merge_responses.sh $+ > $@

hop2_response_2016_sf_run4: hop2_query_expanded.xml hop2_response_Pat_org
	$(TAC_ROOT)/components/bin/merge_responses.sh $+ > $@


hop1_response_2016_sf_run5: hop1_query_expanded_within_doc.xml hop1_response_Pat_doc_exp_org hop1_response_alternate_names hop1_response_patterns hop1_response_Pat_spa
	$(TAC_ROOT)/components/bin/merge_responses.sh $+ > $@

hop2_response_2016_sf_run5: hop2_query_expanded_within_doc.xml hop2_response_Pat_doc_exp_org
	$(TAC_ROOT)/components/bin/merge_responses.sh $+ > $@
...
hop1_%_pp15: hop1_%_ASCII hop1_query_expanded_within_doc.xml /dev/null
	$(TAC_ROOT)/components/bin/postprocess2016_en_es.sh $+ $@
