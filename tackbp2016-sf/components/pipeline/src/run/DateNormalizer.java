  ...
  public static void main(String[] args) throws IOException {
    ...
    for (String line; (line = br.readLine()) != null;) {
      ...
      if (isNIL || !lineParts[1].contains("date")) {
        ...
        //if date normalization fails, then dont provide any fillers,
        //because they are most likely wrong anyway
        //TODO: better date matching for the cases of "early 1990s" "last June" etc.
