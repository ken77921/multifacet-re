...
cat $input_files_list > $input_file
...
echo "$TAC_ROOT/evaluation/bin/2016_04/package_kb_2016.sh $queries ${input_file}_noNIL $hop2_input ${input_file}_hop12"
$TAC_ROOT/evaluation/bin/2016_04/package_kb_2016.sh $queries ${input_file}_noNIL $hop2_input ${input_file}_hop12
...
/opt/perl/bin/perl5.14.2 $eval_perl_script -docs $docs_list -output_file ${output_file} $queries ${input_file}_hop12
